...
public class ImageController {
    ...
    //Image is retrived by image's table id or imageid
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model, HttpSession session) {
        ...
        //if condition to restrict the access to edit the image by the owner of the image.

        if (image.getUser()!= session.getAttribute("loggeduser") ){
...
//if condition to restrict the access to delete the image by the owner of the image.
